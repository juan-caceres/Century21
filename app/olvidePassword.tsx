...
const styles = StyleSheet.create({
  ...
  modalTitle: { fontSize: 20, fontWeight: "bold", color: "#d4af37", marginBottom: 10 },
  modalText: { color: "#fff", fontSize: 16, textAlign: "center", marginBottom: 20 },
  modalButton: { backgroundColor: "#d4af37", paddingVertical: 12, paddingHorizontal: 25, borderRadius: 8 },
